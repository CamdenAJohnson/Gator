...
- Login: Login as the given user. Usage: "login 'name'"
...
- agg: Scraps feeds and stores them into the database on a given interval. Usage: "agg 'time'" 
- addfeed: Adds a feed to be scraped during agg. Usage: "addfeed 'name' 'url'"
